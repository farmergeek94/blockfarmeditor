---
name: blockfarmeditor-release
description: Release BlockFarmEditor NuGet packages - build in Release, compare each package's local VersionPrefix against the latest version on NuGet.org, and push any newer packages. Use when the user asks to release, publish, or push BlockFarmEditor packages to NuGet.
