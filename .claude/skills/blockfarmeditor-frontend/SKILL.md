---
name: blockfarmeditor-frontend
description: Frontend development conventions for BlockFarmEditor's Lit + Vite + TypeScript projects in src/BlockFarmEditor.ClientScripts.RCL (settings-dashboard, definitions-workspace, property-editor, block-editor). Use when creating, modifying, building, or debugging frontend components, web components, or Umbraco backoffice UI in this repo.
---
